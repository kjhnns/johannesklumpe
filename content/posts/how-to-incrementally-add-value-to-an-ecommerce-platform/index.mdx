...
<div style="border-bottom: 1px #000 solid; text-align:center;">users on the catalog page that click on a sofa model</div>
<div style="display: flex;flex-direction: row; text-align:center; justify-content: center">users on the catalog page</div></div></div> 
